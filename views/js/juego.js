...
var juego = {
    ...
    var botonesSonido = document.querySelector("#sonido ul li");
    ...
    tiempo: function () {
        ...
        /*=================================
        CICLO TRAMPAS--para que las trampas se muevan
        ====================================*/
        ...
        for (var i = 0; i < datos.plataforma.length; i++) {
            ...
            //Colision con plataforma de Arriba hacia Abajo
            ...
            //Colision con pltaforma de Abajo hacia Arriba
            ...
            if (datos.desplazamientoEscenario <= datos.limiteEscenario) {
                ...
                //Colision con plataforma de Izquierda a Derecha
                ...
                //Colision con plataforma de Derecha a Izquierda
